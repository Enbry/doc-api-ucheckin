# BO Ucheckin OpenAPI Specification
[![Build Status](https://travis-ci.org/Oonan/doc-api-ucheckin.svg?branch=master)](https://travis-ci.org/Oonan/doc-api-ucheckin)
...
6. If you did everything correct, https://oonan.github.io/doc-api-ucheckin/ will lead to your new docs
...
- Documentation(ReDoc): https://oonan.github.io/doc-api-ucheckin/
- SwaggerUI: https://oonan.github.io/doc-api-ucheckin/swagger-ui/
- Look full spec:
    + JSON https://oonan.github.io/doc-api-ucheckin/swagger.json
    + YAML https://oonan.github.io/doc-api-ucheckin/swagger.yaml
- Preview spec version for branch `[branch]`: https://oonan.github.io/doc-api-ucheckin/preview/[branch]
...
1. Run `npm start`
2. Checkout console output to see where local server is started. You can use all [links](#links) (except `preview`) by replacing https://oonan.github.io/doc-api-ucheckin/ with url from the message: `Server started <url>`
